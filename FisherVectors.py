...
""" Change to library https://github.com/jonasrothfuss/fishervector """
class FisherVectorGMM:
  ...
  def fit(self, X, model_dump_path=None, n_init=1, verbose=True ):
    """
    ...
    if X.ndim == 4:
      self.ndim = 4
      return self._fit(X, model_dump_path=model_dump_path, n_init=n_init, verbose=verbose)
  ...
  def _fit(self, X, n_init, model_dump_path=None,  verbose=True):
    """
